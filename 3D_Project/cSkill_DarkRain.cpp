...
void cSkill_DarkRain::Effect_Init()
{
	...
	m_snowStrom->Init(
		...
		colors, scales,
		3.0f, 3.0f,
		RESOURCE_TEXTURE->GetResource("../Resources/Textures/Effects/darkBizz2.tga"),
		true);
	...
	m_snowStrom_under->Init(
		...
		colors2, scales2,
		3.0f, 9.0f,
		RESOURCE_TEXTURE->GetResource("../Resources/Textures/Effects/DarkStorm.tga"),
		true);
	...
	LPDIRECT3DTEXTURE9 pTex = RESOURCE_TEXTURE->GetResource(
		"../Resources/Textures/Effects/darkBizz.tga");
